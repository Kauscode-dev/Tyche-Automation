...
import { Search, MessageSquare, Zap, TrendingUp, CheckCircle } from "lucide-react";
      ...
      <div className="section-container">
        ...
        >
          ...
          <h2 className="font-heading text-4xl sm:text-5xl font-bold text-foreground mb-4">
            From zero to <span className="text-gradient">pipeline</span> in weeks
          </h2>
          ...
          {steps.map((step, index) => (
            ...
            >
              ...
              {index < steps.length - 1 && (
                <div className="hidden lg:block absolute top-10 left-[calc(100%+1rem)] w-[calc(100%-2rem)] h-0.5 bg-gradient-to-r from-primary/30 to-transparent" />
              )}

              <div className="bg-white rounded-2xl p-6 border border-border shadow-sm hover:shadow-lg transition-shadow h-full">
                {/* Number Badge */}
